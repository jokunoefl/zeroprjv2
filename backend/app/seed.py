...
def seed_math_dependencies(db: Session):
    ...
    dependencies = [
        ...
        (8, "正負の数", "累乗と指数"),
        (9, "整数の性質（倍数・約数）", "正負の数"),
        (10, "最小公倍数・最大公約数", "整数の性質（倍数・約数）"),
        (11, "余りのある割り算", "最小公倍数・最大公約数"),
        (12, "倍数算", "余りのある割り算"),
        (13, "約数算", "倍数算"),
        (14, "整数の規則性", "約数算"),
        (15, "数列の基礎", "整数の規則性"),
        ...
        (44, "合同と相似", "作図"),
        (45, "相似比と面積比", "合同と相似"),
        (46, "面積の求め方（基本図形）", "相似比と面積比"),
        (47, "面積の求め方（複合図形）", "面積の求め方（基本図形）"),
        (48, "面積比の応用", "面積の求め方（複合図形）"),
        (49, "立体図形の基礎", "面積比の応用"),
        (50, "立体図形の体積", "立体図形の基礎"),
        (51, "表面積の求め方", "立体図形の体積"),
        (52, "立体切断", "表面積の求め方"),
        ...
        (77, "表の読み取り", "グラフの読み取り"),
        (78, "関数（比例・反比例）", "表の読み取り"),
        (79, "簡単な一次方程式", "関数（比例・反比例）"),
        (80, "方程式文章題", "簡単な一次方程式"),
        (81, "連立方程式", "方程式文章題"),
        (82, "方程式の利用（割合・速さ）", "連立方程式"),
        (83, "不等式", "方程式の利用（割合・速さ）"),
        (84, "座標の基礎", "不等式"),
        (85, "座標幾何の応用", "座標の基礎"),
        (86, "規則性の応用", "座標幾何の応用"),
        (87, "数のパズル", "規則性の応用"),
        (88, "図形のパズル", "数のパズル"),
        (89, "融合文章題（割合・速さ）", "図形のパズル"),
        (90, "融合文章題（図形・比）", "融合文章題（割合・速さ）"),
        (91, "過去問頻出パターン1", "融合文章題（図形・比）"),
        (92, "過去問頻出パターン2", "過去問頻出パターン1"),
        (93, "過去問頻出パターン3", "過去問頻出パターン2"),
        (94, "模試頻出テーマ1", "過去問頻出パターン3"),
        (95, "模試頻出テーマ2", "模試頻出テーマ1"),
        (96, "模試頻出テーマ3", "模試頻出テーマ2"),
        (97, "難関校オリジナル問題1", "模試頻出テーマ3"),
        (98, "難関校オリジナル問題2", "難関校オリジナル問題1"),
        (99, "難関校オリジナル問題3", "難関校オリジナル問題2"),
        (100, "難関校オリジナル問題4", "難関校オリジナル問題3"),
    ]
    for i, topic_name, prerequisite in dependencies:
        # math_topicsとの紐付けを取得
...
def seed_science_dependencies(db: Session):
    ...
    for i, domain, topic_name, prerequisites in dependencies:
...
def seed_social_dependencies(db: Session):
    ...
    dependencies = [
        ...
        (2, "地理", "日本の地方区分（8地方区分）", "日本の都道府県と県庁所在地", "日本の主要山地・山脈・山岳"),
        (3, "地理", "日本の主要山地・山脈・山岳", "日本の地方区分（8地方区分）", "日本の主要河川と流域"),
        (4, "地理", "日本の主要河川と流域", "日本の主要山地・山脈・山岳", "日本の主要平野と盆地"),
        (5, "地理", "日本の主要平野と盆地", "日本の主要河川と流域", "日本の気候区分"),
        (6, "地理", "日本の気候区分", "日本の主要平野と盆地; 日本の地方区分（8地方区分）", "季節風と降水量の分布"),
        (7, "地理", "季節風と降水量の分布", "日本の気候区分", "農業地域の特徴（稲作・畑作・酪農）"),
        (8, "地理", "農業地域の特徴（稲作・畑作・酪農）", "季節風と降水量の分布", "漁業の種類と漁場"),
        (9, "地理", "漁業の種類と漁場", "農業地域の特徴（稲作・畑作・酪農）", "工業地域の特徴（太平洋ベルトなど）"),
        (10, "地理", "工業地域の特徴（太平洋ベルトなど）", "漁業の種類と漁場", "交通網の発達と都市の発展"),
        (11, "地理", "交通網の発達と都市の発展", "工業地域の特徴（太平洋ベルトなど）", "過疎化・過密化の地域問題"),
        (12, "地理", "過疎化・過密化の地域問題", "交通網の発達と都市の発展", "エネルギー資源と発電方法"),
        (13, "地理", "エネルギー資源と発電方法", "過疎化・過密化の地域問題", "自然災害と防災"),
        (14, "地理", "自然災害と防災", "エネルギー資源と発電方法; 日本の気候区分; 地震の仕組みと震度・マグニチュード", "日本の観光地と文化財"),
        (15, "地理", "日本の観光地と文化財", "自然災害と防災", "世界の大陸と海洋"),
        (16, "地理", "世界の大陸と海洋", "日本の観光地と文化財", "世界の主要国と首都"),
        (17, "地理", "世界の主要国と首都", "世界の大陸と海洋", "世界の気候帯"),
        (18, "地理", "世界の気候帯", "世界の主要国と首都", "世界の農業形態"),
        (19, "地理", "世界の農業形態", "世界の気候帯", "世界の主要な工業地域"),
        (20, "地理", "世界の主要な工業地域", "世界の農業形態", "国際貿易と物流"),
        (21, "地理", "国際貿易と物流", "世界の主要な工業地域", "地球規模の環境問題"),
        (22, "地理", "地球規模の環境問題", "国際貿易と物流", "地図記号と地形図の読み方"),
        (23, "地理", "地図記号と地形図の読み方", "地球規模の環境問題", "緯度・経度と時差計算"),
        (24, "地理", "緯度・経度と時差計算", "地図記号と地形図の読み方; 世界の大陸と海洋", "GIS（地理情報システム）の活用"),
        (25, "地理", "GIS（地理情報システム）の活用", "緯度・経度と時差計算", ""),
        # 歴史 26-50
        (26, "歴史", "旧石器時代と縄文時代の暮らし", "", "弥生時代と稲作の伝来"),
        (27, "歴史", "弥生時代と稲作の伝来", "旧石器時代と縄文時代の暮らし", "古墳時代と大和政権"),
        (28, "歴史", "古墳時代と大和政権", "弥生時代と稲作の伝来", "飛鳥時代と大化の改新"),
        (29, "歴史", "飛鳥時代と大化の改新", "古墳時代と大和政権", "奈良時代と平城京"),
        (30, "歴史", "奈良時代と平城京", "飛鳥時代と大化の改新", "平安時代の貴族文化"),
        (31, "歴史", "平安時代の貴族文化", "奈良時代と平城京", "鎌倉時代と武士の台頭"),
        (32, "歴史", "鎌倉時代と武士の台頭", "平安時代の貴族文化", "室町時代と戦国時代"),
        (33, "歴史", "室町時代と戦国時代", "鎌倉時代と武士の台頭", "安土桃山時代と天下統一"),
        (34, "歴史", "安土桃山時代と天下統一", "室町時代と戦国時代", "江戸時代の政治と身分制度"),
        (35, "歴史", "江戸時代の政治と身分制度", "安土桃山時代と天下統一", "江戸時代の文化（元禄・化政）"),
        (36, "歴史", "江戸時代の文化（元禄・化政）", "江戸時代の政治と身分制度", "鎖国と海外交流"),
        (37, "歴史", "鎖国と海外交流", "江戸時代の文化（元禄・化政）", "幕末の動乱と明治維新"),
        (38, "歴史", "幕末の動乱と明治維新", "鎖国と海外交流", "明治時代の近代化"),
        (39, "歴史", "明治時代の近代化", "幕末の動乱と明治維新", "日清戦争・日露戦争"),
        (40, "歴史", "日清戦争・日露戦争", "明治時代の近代化", "大正デモクラシー"),
        (41, "歴史", "大正デモクラシー", "日清戦争・日露戦争", "昭和時代前期と戦争"),
        (42, "歴史", "昭和時代前期と戦争", "大正デモクラシー", "第二次世界大戦"),
        (43, "歴史", "第二次世界大戦", "昭和時代前期と戦争", "戦後復興と高度経済成長"),
        (44, "歴史", "戦後復興と高度経済成長", "第二次世界大戦", "現代日本の国際関係"),
        (45, "歴史", "現代日本の国際関係", "戦後復興と高度経済成長", "世界史の主要文明（四大文明）"),
        (46, "歴史", "世界史の主要文明（四大文明）", "現代日本の国際関係", "ルネサンスと宗教改革"),
        (47, "歴史", "ルネサンスと宗教改革", "世界史の主要文明（四大文明）", "産業革命と資本主義の発展"),
        (48, "歴史", "産業革命と資本主義の発展", "ルネサンスと宗教改革", "世界大戦と冷戦"),
        (49, "歴史", "世界大戦と冷戦", "産業革命と資本主義の発展", "21世紀の国際情勢"),
        (50, "歴史", "21世紀の国際情勢", "世界大戦と冷戦", ""),
        # 公民 51-70
        (51, "公民", "日本国憲法の三大原則", "", "基本的人権の種類"),
        (52, "公民", "基本的人権の種類", "日本国憲法の三大原則", "三権分立の仕組み"),
        (53, "公民", "三権分立の仕組み", "基本的人権の種類", "国会の役割と仕組み"),
        (54, "公民", "国会の役割と仕組み", "三権分立の仕組み", "内閣の役割と行政機関"),
        (55, "公民", "内閣の役割と行政機関", "国会の役割と仕組み; 三権分立の仕組み", "裁判所の役割"),
        (56, "公民", "裁判所の役割", "内閣の役割と行政機関; 三権分立の仕組み", "地方自治と住民参加"),
        (57, "公民", "地方自治と住民参加", "裁判所の役割", "選挙制度と政治参加"),
        (58, "公民", "選挙制度と政治参加", "地方自治と住民参加", "政党と政治資金"),
        (59, "公民", "政党と政治資金", "選挙制度と政治参加", "国際連合と国際協力"),
        (60, "公民", "国際連合と国際協力", "政党と政治資金", "市場経済の仕組み"),
        (61, "公民", "市場経済の仕組み", "国際連合と国際協力", "需要と供給の関係"),
        (62, "公民", "需要と供給の関係", "市場経済の仕組み", "金融の役割と日銀の機能"),
        (63, "公民", "金融の役割と日銀の機能", "需要と供給の関係; 市場経済の仕組み", "税金の種類と役割"),
        (64, "公民", "税金の種類と役割", "金融の役割と日銀の機能; 市場経済の仕組み", "社会保障制度"),
        (65, "公民", "社会保障制度", "税金の種類と役割", "持続可能な社会と環境保護"),
        (66, "公民", "持続可能な社会と環境保護", "社会保障制度", "情報化社会と個人情報保護"),
        (67, "公民", "情報化社会と個人情報保護", "持続可能な社会と環境保護", "グローバル化と日本経済"),
        (68, "公民", "グローバル化と日本経済", "情報化社会と個人情報保護", "人口問題と少子高齢化"),
        (69, "公民", "人口問題と少子高齢化", "グローバル化と日本経済", "国際平和と安全保障"),
        (70, "公民", "国際平和と安全保障", "人口問題と少子高齢化", ""),
        # 総合 71-100
        (71, "総合", "地理・歴史・公民融合問題（地名と歴史出来事）", "", "地理・歴史・公民融合問題（産業と政治制度）"),
        (72, "総合", "地理・歴史・公民融合問題（産業と政治制度）", "地理・歴史・公民融合問題（地名と歴史出来事）", "統計資料の読み取り（人口・GDP・気温）"),
        (73, "総合", "統計資料の読み取り（人口・GDP・気温）", "地理・歴史・公民融合問題（産業と政治制度）", "地図と統計の複合問題"),
        (74, "総合", "地図と統計の複合問題", "統計資料の読み取り（人口・GDP・気温）", "過去問頻出テーマ分析"),
        (75, "総合", "過去問頻出テーマ分析", "地図と統計の複合問題", "時事問題（国内政治）"),
        (76, "総合", "時事問題（国内政治）", "過去問頻出テーマ分析; 日本国憲法の三大原則; 国会の役割と仕組み", "時事問題（国際情勢）"),
        (77, "総合", "時事問題（国際情勢）", "時事問題（国内政治）; 国際連合と国際協力; 世界の主要国と首都", "国際条約と環境問題"),
        (78, "総合", "国際条約と環境問題", "時事問題（国際情勢）; 国際連合と国際協力; 地球規模の環境問題", "国際的なスポーツ大会と平和活動"),
        (79, "総合", "国際的なスポーツ大会と平和活動", "国際条約と環境問題", "SDGs（持続可能な開発目標）"),
        (80, "総合", "SDGs（持続可能な開発目標）", "国際的なスポーツ大会と平和活動; 地球規模の環境問題; 国際連合と国際協力", "災害対策と国際協力"),
        (81, "総合", "災害対策と国際協力", "SDGs（持続可能な開発目標）", "日本の文化と世界遺産"),
        (82, "総合", "日本の文化と世界遺産", "災害対策と国際協力", "世界の文化遺産と自然遺産"),
        (83, "総合", "世界の文化遺産と自然遺産", "日本の文化と世界遺産", "民族と宗教の多様性"),
        (84, "総合", "民族と宗教の多様性", "世界の文化遺産と自然遺産", "国際経済機関の役割（WTO・IMFなど）"),
        (85, "総合", "国際経済機関の役割（WTO・IMFなど）", "民族と宗教の多様性", "国際政治の枠組み（G7・G20）"),
        (86, "総合", "国際政治の枠組み（G7・G20）", "国際経済機関の役割（WTO・IMFなど）", "平和構築活動とPKO"),
        (87, "総合", "平和構築活動とPKO", "国際政治の枠組み（G7・G20）", "エネルギー安全保障"),
        (88, "総合", "エネルギー安全保障", "平和構築活動とPKO", "情報リテラシーとフェイクニュース対策"),
        (89, "総合", "情報リテラシーとフェイクニュース対策", "エネルギー安全保障", "国際比較で見る社会制度"),
        (90, "総合", "国際比較で見る社会制度", "情報リテラシーとフェイクニュース対策", "地域振興と観光政策"),
        (91, "総合", "地域振興と観光政策", "国際比較で見る社会制度", "地方創生と移住促進"),
        (92, "総合", "地方創生と移住促進", "地域振興と観光政策", "過疎地域の課題と解決策"),
        (93, "総合", "過疎地域の課題と解決策", "地方創生と移住促進", "都市再開発の事例"),
        (94, "総合", "都市再開発の事例", "過疎地域の課題と解決策", "日本の人口ピラミッドの変化"),
        (95, "総合", "日本の人口ピラミッドの変化", "都市再開発の事例", "高齢化社会の福祉政策"),
        (96, "総合", "高齢化社会の福祉政策", "日本の人口ピラミッドの変化", "若者政策と教育改革"),
        (97, "総合", "若者政策と教育改革", "高齢化社会の福祉政策", "働き方改革と雇用制度"),
        (98, "総合", "働き方改革と雇用制度", "若者政策と教育改革", "科学技術と社会"),
        (99, "総合", "科学技術と社会", "働き方改革と雇用制度", "未来の社会像と課題予測"),
        (100, "総合", "未来の社会像と課題予測", "科学技術と社会", ""),
    ]
    for i, domain, topic_name, prerequisites in dependencies:
        # social_topicsとの紐付けを取得
        social_topic = db.query(SocialTopic).filter(SocialTopic.name == topic_name).first()
        topic_id = social_topic.id if social_topic else None
        
        db.add(SocialDependency(
            id=i,
            domain=domain,
            topic_name=topic_name,
            prerequisite_topics=prerequisites if prerequisites else None,
